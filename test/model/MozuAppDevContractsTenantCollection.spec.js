...
(function(root, factory) {
  ...
  beforeEach(function() {
    instance = new KiboAppDevService.MozuAppDevContractsTenantCollection();
  });
  ...
  describe('MozuAppDevContractsTenantCollection', function() {
    it('should create an instance of MozuAppDevContractsTenantCollection', function() {
      // uncomment below and update the code to test MozuAppDevContractsTenantCollection
      //var instane = new KiboAppDevService.MozuAppDevContractsTenantCollection();
      //expect(instance).to.be.a(KiboAppDevService.MozuAppDevContractsTenantCollection);
    });
