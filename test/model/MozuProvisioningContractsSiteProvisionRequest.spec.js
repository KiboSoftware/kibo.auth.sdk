...
(function(root, factory) {
  ...
  beforeEach(function() {
    instance = new KiboAppDevService.MozuProvisioningContractsSiteProvisionRequest();
  });
  ...
  describe('MozuProvisioningContractsSiteProvisionRequest', function() {
    it('should create an instance of MozuProvisioningContractsSiteProvisionRequest', function() {
      // uncomment below and update the code to test MozuProvisioningContractsSiteProvisionRequest
      //var instane = new KiboAppDevService.MozuProvisioningContractsSiteProvisionRequest();
      //expect(instance).to.be.a(KiboAppDevService.MozuProvisioningContractsSiteProvisionRequest);
    });
