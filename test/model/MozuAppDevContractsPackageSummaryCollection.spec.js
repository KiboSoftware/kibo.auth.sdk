...
(function(root, factory) {
  ...
  beforeEach(function() {
    instance = new KiboAppDevService.MozuAppDevContractsPackageSummaryCollection();
  });
  ...
  describe('MozuAppDevContractsPackageSummaryCollection', function() {
    it('should create an instance of MozuAppDevContractsPackageSummaryCollection', function() {
      // uncomment below and update the code to test MozuAppDevContractsPackageSummaryCollection
      //var instane = new KiboAppDevService.MozuAppDevContractsPackageSummaryCollection();
      //expect(instance).to.be.a(KiboAppDevService.MozuAppDevContractsPackageSummaryCollection);
    });
