...
(function(root, factory) {
  ...
  beforeEach(function() {
    instance = new KiboAppDevService.MozuAppDevContractsOauthAuthRequestInternal();
  });
  ...
  describe('MozuAppDevContractsOauthAuthRequestInternal', function() {
    it('should create an instance of MozuAppDevContractsOauthAuthRequestInternal', function() {
      // uncomment below and update the code to test MozuAppDevContractsOauthAuthRequestInternal
      //var instane = new KiboAppDevService.MozuAppDevContractsOauthAuthRequestInternal();
      //expect(instance).to.be.a(KiboAppDevService.MozuAppDevContractsOauthAuthRequestInternal);
    });
