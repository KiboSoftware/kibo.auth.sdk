...
(function(root, factory) {
  ...
  beforeEach(function() {
    instance = new KiboAppDevService.MozuAppDevContractsApplicationChangeNotePagedCollection();
  });
  ...
  describe('MozuAppDevContractsApplicationChangeNotePagedCollection', function() {
    it('should create an instance of MozuAppDevContractsApplicationChangeNotePagedCollection', function() {
      // uncomment below and update the code to test MozuAppDevContractsApplicationChangeNotePagedCollection
      //var instane = new KiboAppDevService.MozuAppDevContractsApplicationChangeNotePagedCollection();
      //expect(instance).to.be.a(KiboAppDevService.MozuAppDevContractsApplicationChangeNotePagedCollection);
    });
