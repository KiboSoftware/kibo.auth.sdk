...
(function(root, factory) {
  ...
  beforeEach(function() {
    instance = new KiboAppDevService.MozuAppDevContractsPackageCollection();
  });
  ...
  describe('MozuAppDevContractsPackageCollection', function() {
    it('should create an instance of MozuAppDevContractsPackageCollection', function() {
      // uncomment below and update the code to test MozuAppDevContractsPackageCollection
      //var instane = new KiboAppDevService.MozuAppDevContractsPackageCollection();
      //expect(instance).to.be.a(KiboAppDevService.MozuAppDevContractsPackageCollection);
    });
