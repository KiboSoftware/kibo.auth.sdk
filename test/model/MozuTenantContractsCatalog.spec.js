...
(function(root, factory) {
  ...
  beforeEach(function() {
    instance = new KiboAppDevService.MozuTenantContractsCatalog();
  });
  ...
  describe('MozuTenantContractsCatalog', function() {
    it('should create an instance of MozuTenantContractsCatalog', function() {
      // uncomment below and update the code to test MozuTenantContractsCatalog
      //var instane = new KiboAppDevService.MozuTenantContractsCatalog();
      //expect(instance).to.be.a(KiboAppDevService.MozuTenantContractsCatalog);
    });
