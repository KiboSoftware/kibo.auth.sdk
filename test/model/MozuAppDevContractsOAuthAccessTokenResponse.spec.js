...
(function(root, factory) {
  ...
  beforeEach(function() {
    instance = new KiboAppDevService.MozuAppDevContractsOAuthAccessTokenResponse();
  });
  ...
  describe('MozuAppDevContractsOAuthAccessTokenResponse', function() {
    it('should create an instance of MozuAppDevContractsOAuthAccessTokenResponse', function() {
      // uncomment below and update the code to test MozuAppDevContractsOAuthAccessTokenResponse
      //var instane = new KiboAppDevService.MozuAppDevContractsOAuthAccessTokenResponse();
      //expect(instance).to.be.a(KiboAppDevService.MozuAppDevContractsOAuthAccessTokenResponse);
    });
