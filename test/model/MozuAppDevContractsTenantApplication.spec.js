...
(function(root, factory) {
  ...
  beforeEach(function() {
    instance = new KiboAppDevService.MozuAppDevContractsTenantApplication();
  });
  ...
  describe('MozuAppDevContractsTenantApplication', function() {
    it('should create an instance of MozuAppDevContractsTenantApplication', function() {
      // uncomment below and update the code to test MozuAppDevContractsTenantApplication
      //var instane = new KiboAppDevService.MozuAppDevContractsTenantApplication();
      //expect(instance).to.be.a(KiboAppDevService.MozuAppDevContractsTenantApplication);
    });
