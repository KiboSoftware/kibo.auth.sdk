...
(function(root, factory) {
  ...
  beforeEach(function() {
    instance = new KiboAppDevService.MozuCoreApiContractsAuditInfo();
  });
  ...
  describe('MozuCoreApiContractsAuditInfo', function() {
    it('should create an instance of MozuCoreApiContractsAuditInfo', function() {
      // uncomment below and update the code to test MozuCoreApiContractsAuditInfo
      //var instane = new KiboAppDevService.MozuCoreApiContractsAuditInfo();
      //expect(instance).to.be.a(KiboAppDevService.MozuCoreApiContractsAuditInfo);
    });
