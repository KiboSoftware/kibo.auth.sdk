...
(function(root, factory) {
  ...
  beforeEach(function() {
    instance = new KiboAppDevService.MozuAppDevContractsApplicationEntitlementCollection();
  });
  ...
  describe('MozuAppDevContractsApplicationEntitlementCollection', function() {
    it('should create an instance of MozuAppDevContractsApplicationEntitlementCollection', function() {
      // uncomment below and update the code to test MozuAppDevContractsApplicationEntitlementCollection
      //var instane = new KiboAppDevService.MozuAppDevContractsApplicationEntitlementCollection();
      //expect(instance).to.be.a(KiboAppDevService.MozuAppDevContractsApplicationEntitlementCollection);
    });
