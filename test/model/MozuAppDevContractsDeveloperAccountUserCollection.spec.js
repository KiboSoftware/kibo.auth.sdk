...
(function(root, factory) {
  ...
  beforeEach(function() {
    instance = new KiboAppDevService.MozuAppDevContractsDeveloperAccountUserCollection();
  });
  ...
  describe('MozuAppDevContractsDeveloperAccountUserCollection', function() {
    it('should create an instance of MozuAppDevContractsDeveloperAccountUserCollection', function() {
      // uncomment below and update the code to test MozuAppDevContractsDeveloperAccountUserCollection
      //var instane = new KiboAppDevService.MozuAppDevContractsDeveloperAccountUserCollection();
      //expect(instance).to.be.a(KiboAppDevService.MozuAppDevContractsDeveloperAccountUserCollection);
    });
