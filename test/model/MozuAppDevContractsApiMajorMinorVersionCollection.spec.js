...
(function(root, factory) {
  ...
  beforeEach(function() {
    instance = new KiboAppDevService.MozuAppDevContractsApiMajorMinorVersionCollection();
  });
  ...
  describe('MozuAppDevContractsApiMajorMinorVersionCollection', function() {
    it('should create an instance of MozuAppDevContractsApiMajorMinorVersionCollection', function() {
      // uncomment below and update the code to test MozuAppDevContractsApiMajorMinorVersionCollection
      //var instane = new KiboAppDevService.MozuAppDevContractsApiMajorMinorVersionCollection();
      //expect(instance).to.be.a(KiboAppDevService.MozuAppDevContractsApiMajorMinorVersionCollection);
    });
