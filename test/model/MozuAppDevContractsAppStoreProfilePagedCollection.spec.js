...
(function(root, factory) {
  ...
  beforeEach(function() {
    instance = new KiboAppDevService.MozuAppDevContractsAppStoreProfilePagedCollection();
  });
  ...
  describe('MozuAppDevContractsAppStoreProfilePagedCollection', function() {
    it('should create an instance of MozuAppDevContractsAppStoreProfilePagedCollection', function() {
      // uncomment below and update the code to test MozuAppDevContractsAppStoreProfilePagedCollection
      //var instane = new KiboAppDevService.MozuAppDevContractsAppStoreProfilePagedCollection();
      //expect(instance).to.be.a(KiboAppDevService.MozuAppDevContractsAppStoreProfilePagedCollection);
    });
