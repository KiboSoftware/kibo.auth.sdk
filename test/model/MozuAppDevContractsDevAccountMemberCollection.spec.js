...
(function(root, factory) {
  ...
  beforeEach(function() {
    instance = new KiboAppDevService.MozuAppDevContractsDevAccountMemberCollection();
  });
  ...
  describe('MozuAppDevContractsDevAccountMemberCollection', function() {
    it('should create an instance of MozuAppDevContractsDevAccountMemberCollection', function() {
      // uncomment below and update the code to test MozuAppDevContractsDevAccountMemberCollection
      //var instane = new KiboAppDevService.MozuAppDevContractsDevAccountMemberCollection();
      //expect(instance).to.be.a(KiboAppDevService.MozuAppDevContractsDevAccountMemberCollection);
    });
