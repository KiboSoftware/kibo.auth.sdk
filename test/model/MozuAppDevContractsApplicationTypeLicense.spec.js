...
(function(root, factory) {
  ...
  beforeEach(function() {
    instance = new KiboAppDevService.MozuAppDevContractsApplicationTypeLicense();
  });
  ...
  describe('MozuAppDevContractsApplicationTypeLicense', function() {
    it('should create an instance of MozuAppDevContractsApplicationTypeLicense', function() {
      // uncomment below and update the code to test MozuAppDevContractsApplicationTypeLicense
      //var instane = new KiboAppDevService.MozuAppDevContractsApplicationTypeLicense();
      //expect(instance).to.be.a(KiboAppDevService.MozuAppDevContractsApplicationTypeLicense);
    });
