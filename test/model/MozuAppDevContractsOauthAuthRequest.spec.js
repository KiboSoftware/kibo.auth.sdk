...
(function(root, factory) {
  ...
  beforeEach(function() {
    instance = new KiboAppDevService.MozuAppDevContractsOauthAuthRequest();
  });
  ...
  describe('MozuAppDevContractsOauthAuthRequest', function() {
    it('should create an instance of MozuAppDevContractsOauthAuthRequest', function() {
      // uncomment below and update the code to test MozuAppDevContractsOauthAuthRequest
      //var instane = new KiboAppDevService.MozuAppDevContractsOauthAuthRequest();
      //expect(instance).to.be.a(KiboAppDevService.MozuAppDevContractsOauthAuthRequest);
    });
