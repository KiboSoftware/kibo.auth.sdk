...
(function(root, factory) {
  ...
  beforeEach(function() {
    instance = new KiboAppDevService.MozuAppDevContractsProjectCollection();
  });
  ...
  describe('MozuAppDevContractsProjectCollection', function() {
    it('should create an instance of MozuAppDevContractsProjectCollection', function() {
      // uncomment below and update the code to test MozuAppDevContractsProjectCollection
      //var instane = new KiboAppDevService.MozuAppDevContractsProjectCollection();
      //expect(instance).to.be.a(KiboAppDevService.MozuAppDevContractsProjectCollection);
    });
