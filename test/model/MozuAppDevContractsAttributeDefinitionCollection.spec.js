...
(function(root, factory) {
  ...
  beforeEach(function() {
    instance = new KiboAppDevService.MozuAppDevContractsAttributeDefinitionCollection();
  });
  ...
  describe('MozuAppDevContractsAttributeDefinitionCollection', function() {
    it('should create an instance of MozuAppDevContractsAttributeDefinitionCollection', function() {
      // uncomment below and update the code to test MozuAppDevContractsAttributeDefinitionCollection
      //var instane = new KiboAppDevService.MozuAppDevContractsAttributeDefinitionCollection();
      //expect(instance).to.be.a(KiboAppDevService.MozuAppDevContractsAttributeDefinitionCollection);
    });
