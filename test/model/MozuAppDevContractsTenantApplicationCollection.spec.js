...
(function(root, factory) {
  ...
  beforeEach(function() {
    instance = new KiboAppDevService.MozuAppDevContractsTenantApplicationCollection();
  });
  ...
  describe('MozuAppDevContractsTenantApplicationCollection', function() {
    it('should create an instance of MozuAppDevContractsTenantApplicationCollection', function() {
      // uncomment below and update the code to test MozuAppDevContractsTenantApplicationCollection
      //var instane = new KiboAppDevService.MozuAppDevContractsTenantApplicationCollection();
      //expect(instance).to.be.a(KiboAppDevService.MozuAppDevContractsTenantApplicationCollection);
    });
