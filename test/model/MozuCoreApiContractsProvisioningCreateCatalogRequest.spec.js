...
(function(root, factory) {
  ...
  beforeEach(function() {
    instance = new KiboAppDevService.MozuCoreApiContractsProvisioningCreateCatalogRequest();
  });
  ...
  describe('MozuCoreApiContractsProvisioningCreateCatalogRequest', function() {
    it('should create an instance of MozuCoreApiContractsProvisioningCreateCatalogRequest', function() {
      // uncomment below and update the code to test MozuCoreApiContractsProvisioningCreateCatalogRequest
      //var instane = new KiboAppDevService.MozuCoreApiContractsProvisioningCreateCatalogRequest();
      //expect(instance).to.be.a(KiboAppDevService.MozuCoreApiContractsProvisioningCreateCatalogRequest);
    });
