...
(function(root, factory) {
  ...
  beforeEach(function() {
    instance = new KiboAppDevService.MozuAppDevContractsProjectSummaryCollection();
  });
  ...
  describe('MozuAppDevContractsProjectSummaryCollection', function() {
    it('should create an instance of MozuAppDevContractsProjectSummaryCollection', function() {
      // uncomment below and update the code to test MozuAppDevContractsProjectSummaryCollection
      //var instane = new KiboAppDevService.MozuAppDevContractsProjectSummaryCollection();
      //expect(instance).to.be.a(KiboAppDevService.MozuAppDevContractsProjectSummaryCollection);
    });
