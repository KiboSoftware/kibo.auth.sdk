...
(function(root, factory) {
  ...
  beforeEach(function() {
    instance = new KiboAppDevService.MozuAppDevContractsApplicationSummaryCollection();
  });
  ...
  describe('MozuAppDevContractsApplicationSummaryCollection', function() {
    it('should create an instance of MozuAppDevContractsApplicationSummaryCollection', function() {
      // uncomment below and update the code to test MozuAppDevContractsApplicationSummaryCollection
      //var instane = new KiboAppDevService.MozuAppDevContractsApplicationSummaryCollection();
      //expect(instance).to.be.a(KiboAppDevService.MozuAppDevContractsApplicationSummaryCollection);
    });
