...
(function(root, factory) {
  ...
  beforeEach(function() {
    instance = new KiboAppDevService.MozuAppDevContractsAppVersion();
  });
  ...
  describe('MozuAppDevContractsAppVersion', function() {
    it('should create an instance of MozuAppDevContractsAppVersion', function() {
      // uncomment below and update the code to test MozuAppDevContractsAppVersion
      //var instane = new KiboAppDevService.MozuAppDevContractsAppVersion();
      //expect(instance).to.be.a(KiboAppDevService.MozuAppDevContractsAppVersion);
    });
