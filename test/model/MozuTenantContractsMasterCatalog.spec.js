...
(function(root, factory) {
  ...
  beforeEach(function() {
    instance = new KiboAppDevService.MozuTenantContractsMasterCatalog();
  });
  ...
  describe('MozuTenantContractsMasterCatalog', function() {
    it('should create an instance of MozuTenantContractsMasterCatalog', function() {
      // uncomment below and update the code to test MozuTenantContractsMasterCatalog
      //var instane = new KiboAppDevService.MozuTenantContractsMasterCatalog();
      //expect(instance).to.be.a(KiboAppDevService.MozuTenantContractsMasterCatalog);
    });
