...
(function(root, factory) {
  ...
  beforeEach(function() {
    instance = new KiboAppDevService.MozuCoreApiContractsProvisioningCreateMasterCatalogRequest();
  });
  ...
  describe('MozuCoreApiContractsProvisioningCreateMasterCatalogRequest', function() {
    it('should create an instance of MozuCoreApiContractsProvisioningCreateMasterCatalogRequest', function() {
      // uncomment below and update the code to test MozuCoreApiContractsProvisioningCreateMasterCatalogRequest
      //var instane = new KiboAppDevService.MozuCoreApiContractsProvisioningCreateMasterCatalogRequest();
      //expect(instance).to.be.a(KiboAppDevService.MozuCoreApiContractsProvisioningCreateMasterCatalogRequest);
    });
