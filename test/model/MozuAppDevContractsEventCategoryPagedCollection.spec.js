...
(function(root, factory) {
  ...
  beforeEach(function() {
    instance = new KiboAppDevService.MozuAppDevContractsEventCategoryPagedCollection();
  });
  ...
  describe('MozuAppDevContractsEventCategoryPagedCollection', function() {
    it('should create an instance of MozuAppDevContractsEventCategoryPagedCollection', function() {
      // uncomment below and update the code to test MozuAppDevContractsEventCategoryPagedCollection
      //var instane = new KiboAppDevService.MozuAppDevContractsEventCategoryPagedCollection();
      //expect(instance).to.be.a(KiboAppDevService.MozuAppDevContractsEventCategoryPagedCollection);
    });
