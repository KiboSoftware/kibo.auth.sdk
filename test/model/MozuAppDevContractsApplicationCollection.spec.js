...
(function(root, factory) {
  ...
  beforeEach(function() {
    instance = new KiboAppDevService.MozuAppDevContractsApplicationCollection();
  });
  ...
  describe('MozuAppDevContractsApplicationCollection', function() {
    it('should create an instance of MozuAppDevContractsApplicationCollection', function() {
      // uncomment below and update the code to test MozuAppDevContractsApplicationCollection
      //var instane = new KiboAppDevService.MozuAppDevContractsApplicationCollection();
      //expect(instance).to.be.a(KiboAppDevService.MozuAppDevContractsApplicationCollection);
    });
