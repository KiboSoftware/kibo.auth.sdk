...
(function(root, factory) {
  ...
  beforeEach(function() {
    instance = new KiboAppDevService.MozuAppDevContractsAssetFileMetadata();
  });
  ...
  describe('MozuAppDevContractsAssetFileMetadata', function() {
    it('should create an instance of MozuAppDevContractsAssetFileMetadata', function() {
      // uncomment below and update the code to test MozuAppDevContractsAssetFileMetadata
      //var instane = new KiboAppDevService.MozuAppDevContractsAssetFileMetadata();
      //expect(instance).to.be.a(KiboAppDevService.MozuAppDevContractsAssetFileMetadata);
    });
