...
(function(root, factory) {
  ...
  beforeEach(function() {
    instance = new KiboAppDevService.MozuAppDevContractsProductionTenantCollection();
  });
  ...
  describe('MozuAppDevContractsProductionTenantCollection', function() {
    it('should create an instance of MozuAppDevContractsProductionTenantCollection', function() {
      // uncomment below and update the code to test MozuAppDevContractsProductionTenantCollection
      //var instane = new KiboAppDevService.MozuAppDevContractsProductionTenantCollection();
      //expect(instance).to.be.a(KiboAppDevService.MozuAppDevContractsProductionTenantCollection);
    });
