...
(function(root, factory) {
  ...
  beforeEach(function() {
    instance = new KiboAppDevService.MozuAppDevContractsAccessTokenResponse();
  });
  ...
  describe('MozuAppDevContractsAccessTokenResponse', function() {
    it('should create an instance of MozuAppDevContractsAccessTokenResponse', function() {
      // uncomment below and update the code to test MozuAppDevContractsAccessTokenResponse
      //var instane = new KiboAppDevService.MozuAppDevContractsAccessTokenResponse();
      //expect(instance).to.be.a(KiboAppDevService.MozuAppDevContractsAccessTokenResponse);
    });
